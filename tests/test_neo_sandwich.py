...
CONTRACT_PATH = r"/contracts\neo_sandwich.py"  # todo - change to relative
...
class TestNeoSandwich(BaseTest):
    ...
    compiled_contract_path = CONTRACT_PATH.replace(".py", ".nef")
    ...
    # def test_onNEP17Payment(self):
    #     self.engine.add_contract(self.compiled_contract_path)
    #
    ...
    #     # deploying wrapped_neo smart contracts
